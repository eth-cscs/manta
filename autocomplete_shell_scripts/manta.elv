...
set edit:completion:arg-completer[manta] = {|@words|
    ...
    var completions = [
        &'manta'= {
            ...
            cand add 'Add/Create new elements to system. Nodes will be added to the user''s ''parent'' group'
        ...
        &'manta;get;kernel-parameters'= {
            cand -x 'Comma separated list of xnames to retrieve the kernel parameters from. eg: ''x1001c1s0b0n1,x1001c1s0b1n0'''
            cand --xnames 'Comma separated list of xnames to retrieve the kernel parameters from. eg: ''x1001c1s0b0n1,x1001c1s0b1n0'''
        ...
        &'manta;add'= {
            cand -h 'Print help'
            cand --help 'Print help'
            cand node 'Add/Create new node'
            cand group 'Add/Create new group'
            cand hw-component 'WIP - Add hw components from a cluster'
            cand kernel-parameters 'Add/Create kernel parameters'
            cand help 'Print this message or the help of the given subcommand(s)'
        }
        &'manta;add;node'= {
            cand -i 'Xname'
            cand --id 'Xname'
            cand -g 'Group name the node belongs to'
            cand --group 'Group name the node belongs to'
            cand -H 'hardware'
            cand --hardware 'hardware'
            cand -a 'Architecture'
            cand --arch 'Architecture'
            cand -d 'Disable node upon creation'
            cand --disabled 'Disable node upon creation'
            cand -h 'Print help'
            cand --help 'Print help'
        }
        &'manta;add;group'= {
        ...
        &'manta;add;kernel-parameters'= {
            cand -x 'Comma separated list of nodes to set kernel parameters. eg ''x1003c1s7b0n0,1003c1s7b0n1,x1003c1s7b1n0'''
            cand --xnames 'Comma separated list of nodes to set kernel parameters. eg ''x1003c1s7b0n0,1003c1s7b0n1,x1003c1s7b1n0'''
            cand -H 'Cluster to set kernel parameters'
            cand --hsm-group 'Cluster to set kernel parameters'
        ...
        &'manta;delete'= {
            ...
            cand configurations 'Deletes CFS configurations and all data related (CFS sessions, BOS sessiontemplates, BOS sessions and images).'
        ...
        &'manta;delete;configurations'= {
            cand -n 'CFS configuration, CFS sessions, BOS sessiontemplate, BOS sessions and IMS images related to the CFS configuration will be deleted. eg: manta delete --configuration-name my-config-v1.0 Deletes all data related to CFS configuration with name ''my-config-v0.1'''
            cand --configuration-name 'CFS configuration, CFS sessions, BOS sessiontemplate, BOS sessions and IMS images related to the CFS configuration will be deleted. eg: manta delete --configuration-name my-config-v1.0 Deletes all data related to CFS configuration with name ''my-config-v0.1'''
            cand -p 'Glob pattern for configuration name'
            cand --pattern 'Glob pattern for configuration name'
            cand -s 'Deletes CFS configurations, CFS sessions, BOS sessiontemplate, BOS sessions and images related to CFS configurations with ''last updated'' after since date. Note: date format is %Y-%m-%d eg: manta delete --since 2023-01-01 --until 2023-10-01 Deletes all data related to CFS configurations created or updated between 01/01/2023T00:00:00Z and 01/10/2023T00:00:00Z'
            cand --since 'Deletes CFS configurations, CFS sessions, BOS sessiontemplate, BOS sessions and images related to CFS configurations with ''last updated'' after since date. Note: date format is %Y-%m-%d eg: manta delete --since 2023-01-01 --until 2023-10-01 Deletes all data related to CFS configurations created or updated between 01/01/2023T00:00:00Z and 01/10/2023T00:00:00Z'
            cand -u 'Deletes CFS configuration, CFS sessions, BOS sessiontemplate, BOS sessions and images related to the CFS configuration with ''last updated'' before until date. Note: date format is %Y-%m-%d eg: manta delete --until 2023-10-01 Deletes all data related to CFS configurations created or updated before 01/10/2023T00:00:00Z'
            cand --until 'Deletes CFS configuration, CFS sessions, BOS sessiontemplate, BOS sessions and images related to the CFS configuration with ''last updated'' before until date. Note: date format is %Y-%m-%d eg: manta delete --until 2023-10-01 Deletes all data related to CFS configurations created or updated before 01/10/2023T00:00:00Z'
            cand -y 'Automatic yes to prompts; assume ''yes'' as answer to all prompts and run non-interactively. Image artifacts and configurations used by nodes will not be deleted'
            cand --assume-yes 'Automatic yes to prompts; assume ''yes'' as answer to all prompts and run non-interactively. Image artifacts and configurations used by nodes will not be deleted'
            cand -h 'Print help'
            cand --help 'Print help'
        }
        ...
        &'manta;add-nodes-to-groups'= {
            ...
            cand -n 'Comma separated list of nids or xnames. eg ''x1003c1s7b0n0,1003c1s7b0n1,x1003c1s7b1n0'' or ''nid001313,nid001314''  Hostlist format also accepted eg ''x1003c1s7b0n[0-1],x1003c1s7b1n0'' or ''nid0000[10-15]'''
            cand --nodes 'Comma separated list of nids or xnames. eg ''x1003c1s7b0n0,1003c1s7b0n1,x1003c1s7b1n0'' or ''nid001313,nid001314''  Hostlist format also accepted eg ''x1003c1s7b0n[0-1],x1003c1s7b1n0'' or ''nid0000[10-15]'''
            cand -r 'Input nodes in regex format.'
            cand --regex 'Input nodes in regex format.'
            cand -d 'Simulates the execution of the command without making any actual changes.'
            cand --dry-run 'Simulates the execution of the command without making any actual changes.'
