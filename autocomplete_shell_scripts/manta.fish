...
complete -c manta -n "__fish_manta_needs_command" -f -a "add" -d 'Add hw components to cluster'
...
complete -c manta -n "__fish_manta_using_subcommand config; and not __fish_seen_subcommand_from show set unset generate-autocomplete help" -s h -l help -d 'Print help'
complete -c manta -n "__fish_manta_using_subcommand config; and not __fish_seen_subcommand_from show set unset generate-autocomplete help" -f -a "show" -d 'Show config values'
complete -c manta -n "__fish_manta_using_subcommand config; and not __fish_seen_subcommand_from show set unset generate-autocomplete help" -f -a "set" -d 'Change config values'
complete -c manta -n "__fish_manta_using_subcommand config; and not __fish_seen_subcommand_from show set unset generate-autocomplete help" -f -a "unset" -d 'Reset config values'
complete -c manta -n "__fish_manta_using_subcommand config; and not __fish_seen_subcommand_from show set unset generate-autocomplete help" -f -a "generate-autocomplete" -d 'Generate shell auto completion script'
complete -c manta -n "__fish_manta_using_subcommand config; and not __fish_seen_subcommand_from show set unset generate-autocomplete help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c manta -n "__fish_manta_using_subcommand config; and __fish_seen_subcommand_from generate-autocomplete" -s s -l shell -d 'Shell type. Will try to guess from $SHELL if missing' -r -f -a "bash\t''
zsh\t''
fish\t''"
complete -c manta -n "__fish_manta_using_subcommand config; and __fish_seen_subcommand_from generate-autocomplete" -s p -l path -d 'Path to put the autocomplete script or prints to stdout if missing. NOTE: Do not specify filename, only path to directory' -r -F
complete -c manta -n "__fish_manta_using_subcommand config; and __fish_seen_subcommand_from generate-autocomplete" -s h -l help -d 'Print help'
...
complete -c manta -n "__fish_manta_using_subcommand config; and __fish_seen_subcommand_from help" -f -a "generate-autocomplete" -d 'Generate shell auto completion script'
...
complete -c manta -n "__fish_manta_using_subcommand get; and not __fish_seen_subcommand_from hw-component sessions configurations templates cluster nodes hsm-groups images kernel-parameters help" -s h -l help -d 'Print help'
complete -c manta -n "__fish_manta_using_subcommand get; and not __fish_seen_subcommand_from hw-component sessions configurations templates cluster nodes hsm-groups images kernel-parameters help" -f -a "hw-component" -d 'Get hardware components1 for a cluster or a node'
complete -c manta -n "__fish_manta_using_subcommand get; and not __fish_seen_subcommand_from hw-component sessions configurations templates cluster nodes hsm-groups images kernel-parameters help" -f -a "sessions" -d 'Get information from Shasta CFS session'
complete -c manta -n "__fish_manta_using_subcommand get; and not __fish_seen_subcommand_from hw-component sessions configurations templates cluster nodes hsm-groups images kernel-parameters help" -f -a "configurations" -d 'Get information from Shasta CFS configuration'
complete -c manta -n "__fish_manta_using_subcommand get; and not __fish_seen_subcommand_from hw-component sessions configurations templates cluster nodes hsm-groups images kernel-parameters help" -f -a "templates" -d 'Get information from Shasta BOS template'
complete -c manta -n "__fish_manta_using_subcommand get; and not __fish_seen_subcommand_from hw-component sessions configurations templates cluster nodes hsm-groups images kernel-parameters help" -f -a "cluster" -d 'Get cluster details'
complete -c manta -n "__fish_manta_using_subcommand get; and not __fish_seen_subcommand_from hw-component sessions configurations templates cluster nodes hsm-groups images kernel-parameters help" -f -a "nodes" -d 'Get node details'
complete -c manta -n "__fish_manta_using_subcommand get; and not __fish_seen_subcommand_from hw-component sessions configurations templates cluster nodes hsm-groups images kernel-parameters help" -f -a "hsm-groups" -d 'DEPRECATED - Please do not use this command. Get HSM groups details'
complete -c manta -n "__fish_manta_using_subcommand get; and not __fish_seen_subcommand_from hw-component sessions configurations templates cluster nodes hsm-groups images kernel-parameters help" -f -a "images" -d 'Get image information'
complete -c manta -n "__fish_manta_using_subcommand get; and not __fish_seen_subcommand_from hw-component sessions configurations templates cluster nodes hsm-groups images kernel-parameters help" -f -a "kernel-parameters" -d 'Get kernel-parameters information'
complete -c manta -n "__fish_manta_using_subcommand get; and not __fish_seen_subcommand_from hw-component sessions configurations templates cluster nodes hsm-groups images kernel-parameters help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c manta -n "__fish_manta_using_subcommand get; and __fish_seen_subcommand_from kernel-parameters" -s x -l xnames -d 'Comma separated list of xnames to retreive the kernel parameters from. eg: \'x1001c1s0b0n1,x1001c1s0b1n0\'' -r
...
complete -c manta -n "__fish_manta_using_subcommand add; and __fish_seen_subcommand_from kernel-parameters" -s x -l xnames -d 'Comma separated list of nodes to set runtime configuration. eg \'x1003c1s7b0n0,1003c1s7b0n1,x1003c1s7b1n0\'' -r
...
complete -c manta -n "__fish_manta_using_subcommand log" -s c -l cluster -d 'Show logs most recent CFS session logs created for cluster.' -r
complete -c manta -n "__fish_manta_using_subcommand log" -s n -l node -d 'Show logs most recent CFS session logs created for a node.' -r
...
complete -c manta -n "__fish_manta_using_subcommand add-nodes-to-groups" -s n -l nodes -d 'List of xnames or nids. eg \'x1003c1s7b0n0,1003c1s7b0n1,x1003c1s7b1n0\' or \'nid001313,nid001314\'  Host list also accepted eg \'x1003c1s7b0n[0-1],x1003c1s7b1n0\' or \'nid00131[0-9]\'' -r
...
complete -c manta -n "__fish_manta_using_subcommand remove-nodes-from-groups" -s n -l nodes -d 'List of xnames or nids. eg \'x1003c1s7b0n0,1003c1s7b0n1,x1003c1s7b1n0\' or \'nid001313,nid001314\'  Host list also accepted eg \'x1003c1s7b0n[0-1],x1003c1s7b1n0\' or \'nid00131[0-9]\'' -r
...
complete -c manta -n "__fish_manta_using_subcommand help; and not __fish_seen_subcommand_from config get add apply delete migrate power log console validate-local-repo add-nodes-to-groups remove-nodes-from-groups help" -f -a "add" -d 'Add hw components to cluster'
...
complete -c manta -n "__fish_manta_using_subcommand help; and __fish_seen_subcommand_from config" -f -a "generate-autocomplete" -d 'Generate shell auto completion script'
