...
//! the kernel-parameter endpoints (`/v2/kernel-parameters/*`).
//!
...
/// `POST /v2/kernel-parameters/apply`.
...
/// Request body for `POST /v2/kernel-parameters/apply`.
///
...
/// Request body for `POST /v2/kernel-parameters/add` (append mode).
#[derive(Debug, Serialize, Deserialize, ToSchema)]
...
/// Request body for `DELETE /v2/kernel-parameters`.
#[derive(Debug, Serialize, Deserialize, ToSchema)]
