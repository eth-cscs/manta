...
//! `POST /v2/hardware-clusters/{target}/*` and
//! `DELETE /v2/hardware-clusters/{target}/members` endpoints.

use serde::{Deserialize, Serialize};
use utoipa::ToSchema;

/// Request body for `POST /v2/hardware-clusters/{target}/members`.
///
...
/// Request body for `DELETE /v2/hardware-clusters/{target}/members`.
///
