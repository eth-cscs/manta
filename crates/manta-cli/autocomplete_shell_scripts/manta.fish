...
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -l site -d 'Override the active site for this invocation' -r
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -s h -l help -d 'Print help'
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -f -a "hardware" -d '[experimental] Rescale a group\'s hardware allocation'
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -f -a "sat-file" -d 'Process a SAT file to create configurations, images, and session templates'
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -f -a "boot" -d 'Update boot parameters'
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -f -a "runtime-configuration" -d 'Set the CFS runtime configuration on a set of nodes or a group'
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -f -a "boot-parameters" -d 'Update boot parameters for nodes'
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -f -a "redfish-endpoints" -d 'Update an existing Redfish endpoint'
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -f -a "redfish-endpoint" -d 'Update an existing Redfish endpoint'
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -f -a "kernel-parameters" -d 'Replace the full kernel-parameters string on nodes (drops any existing parameters not listed)'
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -f -a "ephemeral-environment" -d 'Launch an ephemeral SSH environment from an image'
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -f -a "template" -d 'Boot nodes using an existing session template'
complete -c manta -n "__fish_manta_using_subcommand apply; and not __fish_seen_subcommand_from hardware sat-file boot runtime-configuration boot-parameters redfish-endpoints redfish-endpoint kernel-parameters ephemeral-environment template help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c manta -n "__fish_manta_using_subcommand apply; and __fish_seen_subcommand_from runtime-configuration" -l site -d 'Override the active site for this invocation' -r
complete -c manta -n "__fish_manta_using_subcommand apply; and __fish_seen_subcommand_from runtime-configuration" -s h -l help -d 'Print help'
complete -c manta -n "__fish_manta_using_subcommand apply; and __fish_seen_subcommand_from runtime-configuration" -f -a "nodes" -d 'Set the runtime CFS configuration on a set of nodes'
complete -c manta -n "__fish_manta_using_subcommand apply; and __fish_seen_subcommand_from runtime-configuration" -f -a "group" -d 'Set the runtime CFS configuration on all nodes in a group'
complete -c manta -n "__fish_manta_using_subcommand apply; and __fish_seen_subcommand_from runtime-configuration" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c manta -n "__fish_manta_using_subcommand apply; and __fish_seen_subcommand_from help" -f -a "boot" -d 'Update boot parameters'
complete -c manta -n "__fish_manta_using_subcommand apply; and __fish_seen_subcommand_from help" -f -a "runtime-configuration" -d 'Set the CFS runtime configuration on a set of nodes or a group'
...
complete -c manta -n "__fish_manta_using_subcommand help; and __fish_seen_subcommand_from apply" -f -a "boot" -d 'Update boot parameters'
complete -c manta -n "__fish_manta_using_subcommand help; and __fish_seen_subcommand_from apply" -f -a "runtime-configuration" -d 'Set the CFS runtime configuration on a set of nodes or a group'
