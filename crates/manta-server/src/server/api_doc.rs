...
#[openapi(
  ...
  components(schemas(
    ...
    manta_shared::types::wire::responses::CreatedResponse,
    manta_shared::types::wire::responses::AddNodeResponse,
    manta_shared::types::wire::responses::CreateSessionResponse,
    manta_shared::types::wire::responses::EphemeralEnvResponse,
    manta_shared::types::wire::responses::CompletedResponse,
    manta_shared::types::wire::responses::DeleteSessionResponse,
    manta_shared::types::wire::responses::MigrateNodesPairResult,
    manta_shared::types::wire::responses::MigrateNodesResponse,
