...
//!
//! - `GET    /v2/kernel-parameters`         → [`get_kernel_parameters`]
//! - `POST   /v2/kernel-parameters/apply`   → [`apply_kernel_parameters`]
//! - `POST   /v2/kernel-parameters/add`     → [`add_kernel_parameters`]
//! - `DELETE /v2/kernel-parameters`         → [`delete_kernel_parameters`]
//!
...
// ---------------------------------------------------------------------------
// POST /v2/kernel-parameters/apply — Apply kernel parameter changes
// ---------------------------------------------------------------------------
...
/// `POST /v2/kernel-parameters/apply` — add, replace, or delete kernel parameters on nodes.
...
// ---------------------------------------------------------------------------
// POST /v2/kernel-parameters/add
// ---------------------------------------------------------------------------

pub use manta_shared::types::api::kernel_parameters::AddKernelParametersRequest;

/// `POST /v2/kernel-parameters/add` — merge new kernel parameters into existing node BSS entries.
...
// ---------------------------------------------------------------------------
// DELETE /v2/kernel-parameters
// ---------------------------------------------------------------------------

pub use manta_shared::types::api::kernel_parameters::DeleteKernelParametersRequest;

/// `DELETE /v2/kernel-parameters` — remove named kernel parameters from node BSS entries.
