...
//!
//! `POST /v2/ephemeral-env` → [`create_ephemeral_env`] — wraps
...
// ---------------------------------------------------------------------------
// POST /v2/ephemeral-env — Create ephemeral CFS environment
// ---------------------------------------------------------------------------
...
/// `POST /v2/ephemeral-env` — launch an ephemeral CFS environment from an IMS image.
