...
pub async fn exec(
    ...
    ims_update_image_add_manifest(shasta_token, shasta_base_url, shasta_root_cert, &ims_image_name, &ims_image_id,).await;
...
async fn ims_update_image_add_manifest(shasta_token: &str,
                                       shasta_base_url: &str,
                                       shasta_root_cert: &[u8],
