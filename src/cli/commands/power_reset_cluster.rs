...
pub async fn exec(
    ...
    log::info!(target: "app::audit", "User: {} ({}) ; Operation: Power reset cluster {}", jwt_claims["name"].as_str().unwrap(), jwt_claims["preferred_username"].as_str().unwrap(), hsm_group_name_arg_opt);
}
